    ...
    function showPage(pageId) {
      ...
      switch(pageId) {
        ...
        case 'categoryPage':
          ...
          break;
        // brandsPage handled by brand.js
      }
    }
      ...
      if (window.firebase && window.firebase.auth) {
        window.firebase.onAuthStateChanged(window.firebase.auth, user => {
          if (user) {
            ...
            // Brand following strip loaded by brand.js if present
            setTimeout(function() { if (typeof window.loadFollowingProducts === 'function') window.loadFollowingProducts(); }, 1500);
