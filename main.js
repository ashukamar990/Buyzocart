    ...
    function renderReviews(reviewList, containerId) {
      ...
      reviewList.forEach(review => {
        ...
        if (review.fileUrl && review.fileType === 'image') {
          mediaHtml = `<div class="review-file-preview"><img src="${sanitizeURL(review.fileUrl)}" alt="Review photo" loading="lazy" style="max-width:120px;max-height:120px;border-radius:8px;object-fit:cover;cursor:pointer;" class="review-img-trigger" data-url="${sanitizeURL(review.fileUrl)}"></div>`;
        ...
        reviewItem.innerHTML = `
          ...
          <div style="font-size:11px;color:#94a3b8;margin-bottom:6px;">${escapeHTML(date)}</div>
        ...
        if (imgTrigger) imgTrigger.addEventListener('click', function() { window.open(this.dataset.url, '_blank'); });
