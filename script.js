...
function loadCategories() {
  ...
  categoriesRef.on('value', (snapshot) => {
    ...
    renderCategories([
      "All", "Men", "Women", "Kids", "Electronics", "Home", "Accessories"
    ]);
  });
}
...
function loadWishlist() {
  ...
  wishlistRef.on('value', (snapshot) => {
    userWishlist = [];
    snapshot.forEach((childSnapshot) => {
      userWishlist.push(childSnapshot.val().productId);
    });
    ...
    card.innerHTML = `
      <div class="product-img-slider-container">
        ...
        <div class="product-card-actions">
          <button class="product-card-btn wishlist-btn active" data-product-id="${product.id}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
            </svg>
          </button>
          <button class="product-card-btn share-btn" data-product-id="${product.id}">
  ...
  featuredProducts.forEach(product => {
    ...
    card.innerHTML = `
      <div class="product-img-slider-container">
        <div class="product-img-slider" style="background-image:url('${product.images[0] || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e'}')"></div>
        <div class="product-card-actions">
          <button class="product-card-btn wishlist-btn" data-product-id="${product.id}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
            </svg>
          </button>
    ...
    // Set up image slider if multiple images
...
function updateUserUI() {
  ...
  if (currentUser) {
    ...
    // Update avatars
    if (photoURL) {
      if (userAvatar) userAvatar.innerHTML = `<img src="${photoURL}" alt="${displayName}">`;
      if (mobileUserAvatar) mobileUserAvatar.innerHTML = `<img src="${photoURL}" alt="${displayName}">`;
    } else {
      if (userAvatar) userAvatar.textContent = initials.substring(0, 2);
      if (mobileUserAvatar) mobileUserAvatar.textContent = initials.substring(0, 2);
    }
  } else {
...
// Share product
function shareProduct(productId = null) {
  if (!productId) {
    productId = document.getElementById('detailWishlistBtn').getAttribute('data-product-id');
  }
...
function loadDemoProducts() {
  PRODUCTS = [
    ...
    },
    {
      ...
      price: 1299,
      desc: "Cotton, regular fit",
      fullDesc: "This comfortable cotton shirt features a regular fit and is perfect for casual outings or office wear. Available in multiple colors.",
      images: [
        "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
        "https://images.unsplash.com/photo-1621072156002-e2fccdc0b176?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
        "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60"
      ],
      sizes: ["S", "M", "L", "XL", "XXL"],
      category: "Men",
      sku: "MEN-SHR-005",
    ...
    },
    {
      ...
      price: 2299,
      desc: "Leather, crossbody style",
      fullDesc: "This elegant leather handbag features a crossbody design with multiple compartments. Perfect for both casual and formal occasions.",
      images: [
    ...
    },
    {
      ...
      fullDesc: "Stay connected and monitor your health with this feature-rich smartwatch. Includes fitness tracking, heart rate monitoring, and smartphone notifications.",
      images: [
        ...
        "https://images.unsplash.com/photo-1579586337278-3f436c25d4a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60"
      ],
      sizes: ["S", "M", "L"],
      category: "Electronics",
      sku: "SMT-WCH-007",
    ...
    },
    {
      ...
      price: 799,
      desc: "Pack of 3, cotton",
      fullDesc: "This set includes 3 comfortable cotton t-shirts perfect for everyday wear. Available in various color combinations for boys and girls.",
      images: [
        "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
        "https://images.unsplash.com/photo-1519457431-44ccd64a579b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
        "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60"
      ],
