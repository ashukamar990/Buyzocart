...
def run_test(page):
    ...
    page.goto("http://localhost:8007/index.html")
    ...
    page.evaluate("""() => {
        ...
        console.log('Environment ready. Calling confirmOrder...');
        try {
            confirmOrder().then(() => {
            ...
            console.error('Error calling confirmOrder:', e);
        }
    }""")
    ...
    page.screenshot(path="/home/jules/verification/screenshots/debug_test_v5.png")
...
if __name__ == "__main__":
    server = subprocess.Popen(["python3", "-m", "http.server", "8007"])
    time.sleep(2)
    try:
